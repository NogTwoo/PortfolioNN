...
const projects = [
  ...
  { id: "03", name: "Projeto Low-Code: AutoMarketing", version: "Pipeline", descPt: "15min → 2min por post. Pipeline de automação Instagram com Google Forms, Make.com, Apify e Buffer.", descEn: "15min → 2min per post. Instagram automation pipeline with Google Forms, Make.com, Apify & Buffer.", tags: ["Make.com", "Apify", "Buffer"], status: "active", accent: "#00d4ff", link:"/images/arq_crm_automation.png"},
